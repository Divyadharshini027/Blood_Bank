...
<head>
	<title>Life's Liquid Gold| Contact Us </title>
	<!-- Meta tag Keywords -->
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p style="font-size:20px;color:#000" class="mt-2">We'll be glad to hear from you!</p>
			</div>
			<div class="d-flex">
					...
					<form action="#" method="post">
						<div class="d-flex space-d-flex">
							...
							<label for="phone">Mobile Number</label>
								<input type="number" class="form-control" id="phone" name="contactno"  placeholder="Please enter your phone number.">
							</div>
						</div>
						...
						<div class="form-group">
							<input style="background-image: linear-gradient(to right,#A00000, ##f4343c)" type="submit" value="Send Message" name="send">
						</div>
					</form>
				</div>
			</div>
