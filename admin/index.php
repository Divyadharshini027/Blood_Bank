						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<button style="background-image: linear-gradient(to right,#A00000, #f75158);padding:10px;border:none" class="btn btn-primary btn-block" name="login" type="submit">LOGIN</button>
									<!-- Dhanabal -->
<a href="forgot-password.php" >Forgot Password</a>
								</form>
								<div class="card-footer text-center" style="padding-top: 30px;">
                                        <div class="small"><a style="background-image: linear-gradient(to right,#A00000, #f75158);padding:10px;border:none" href="../index.php" class="btn btn-primary">Back to Home</a></div>
                                    </div>
							</div>
						</div>
					</div>
