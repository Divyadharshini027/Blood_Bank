...
<head>
	<title>Life's Liquid Gold | Search Blood Donor </title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<form name="donar" method="post" style="padding: 30px;">
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-4 mb-4">
						<div><input style="background-image: linear-gradient(to right,#A00000, #f75158);padding:10px;border:none" type="submit" name="sub" class="btn btn-primary" value="submit" style="cursor:pointer"></div>
					</div>
				</div>
				<!-- /.row -->
			</form>
